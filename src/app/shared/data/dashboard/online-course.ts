...
let primary_color = localStorage.getItem("primary_color") || "#FFC107";
...
export let learningChart: any = {
  ...
  colors: ["var(--theme-deafult)", "#F47DEA", "#FFA941", "#FFC200", "#54BA4A", "#3DA831", "#57B9F6", "#FF3377", "#773ACE", "#945CFF", "#FFC107"],
  stroke: {
    width: 1.5,
    curve: "smooth",
  },
