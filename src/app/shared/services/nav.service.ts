...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    {  title: "Mental Health", icon: "faq", type: "sub", active: false ,
    children: [
      { path: "/faq/AddMentalHealth", title: "Add MentalHealth", type: "link" },
      { path: "/faq/GetMyMentalHealth", title: "Get MyMentalHealth ", type: "link" },
      { path: "/faq/afficheRecommendation", title: "Afficher recommendations ", type: "link" },
      {path:  "/faq/podcastsAffiche", title:"Afficher podcasts",type:"link"},
      {path:  "/faq/ReandomRec", title:"Recommendations aléatoires",type:"link"},
      //{path:  "/faq/Dashboard", title:"Dashboard",type:"link"},
    ],},
    ...
    //{ path: "d", title: "Dashboard", icon: "home", type: "link" },
    { path: "/faq/Dashboard", title: "Dashboard", icon: "home", type: "link" },
    // {
